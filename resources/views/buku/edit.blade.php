...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('buku.update', $book->id) }}" method="post">
            ...
            <select name="id_lokasi" class="form-select"><option value="">--Pilih Lokasi--</option>
            ...
            <select name="id_kategori" class="form-select"><option value="">--Pilih Kategori--</option>
            ...
            <input type="number" min="1" max="1000" class="form-control" name="stock" value="{{ $book->stock }}">
